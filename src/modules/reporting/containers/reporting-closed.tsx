...
const Closed = withRouter(
  connect(mapStateToProps, mapDispatchToProps)(ReportingClosed)
);
...
const markets = [
  {
    ...
    eventID:
      "0xee03ff4923cb4fc8f2f2370e0f1d5cffd321342d304e221e566623616f676ba4",
    minValue: "1",
    maxValue: "2",
    numOutcomes: 2,
    type: "binary",
    ...
    outcomes: [
      {
        ...
        name: "Yes",
        marketID:
          "0xcd7b177af7a12ec3be1c7f992ec7d608959630f2113227a2cdd9db562bd01eb4",
        lastPrice: {
          value: 0,
          formattedValue: 0,
          formatted: "0",
    ...
    formattedDescription:
      "will_bitcoin_be_surpassed_by_ethereum_by_the_end_of_2018",
    isBinary: true,
    isCategorical: false,
    isScalar: false,
  ...
  },
  {
    ...
    eventID:
      "0x55c24b4a613d57869cfb42a640d744d2d646aaa1f30e0147c6a7da5a6a72eeb8",
    minValue: "1",
    maxValue: "2",
    numOutcomes: 2,
    type: "binary",
    ...
    outcomes: [
      {
        ...
        name: "Yes",
        marketID:
          "0xbb8b7835162b95b6994013cd04d8f28125c3c11c8bae84c73772785a666ca272",
        lastPrice: {
          value: 0.3,
          formattedValue: 0.3,
          formatted: "0.3000",
