...
type ReportingReportProps = {
  market: object
};
type ReportingReportState = { currentStep: number } & {
  currentStep: any
} & any & {
    currentStep: number,
    isMarketValid: null,
    ...
    stake: string,
    validations: { isMarketValid: boolean, stake: boolean }
  };
export default class ReportingReport extends Component<
  ReportingReportProps,
  ReportingReportState
> {
  constructor(props) {
    super(props);
    this.state = {
