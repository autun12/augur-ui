...
class AccountHeader extends Component<AccountHeaderProps, {}> {
  ...
  updateText() {
    ...
    containerWidth = this.props.isMobile
  ...
  render() {
    ...
    const totalPLValue =
      p.stats[1].totalPL.value === null
        ? "0.0000"
        : p.stats[1].totalPL.value.rounded;
    const totalPLMonthValue =
      p.stats[1].totalPLMonth.value === null
        ? "0"
        : p.stats[1].totalPLMonth.value.rounded;
    const totalPLDayValue =
      p.stats[1].totalPLDay.value === null
        ? "0"
        : p.stats[1].totalPLDay.value.rounded;
    return (
      <div className={Styles.AccountHeader}>
        <div
          ref={ethCurrencyContainer => {
            this.ethCurrencyContainer = ethCurrencyContainer;
          }}
        ...
        >
          <span
            ref={ethCurrencyValue => {
              this.ethCurrencyValue = ethCurrencyValue;
            }}
          ...
          >
            ...
            <span
              ref={ethCurrencyLabel => {
                this.ethCurrencyLabel = ethCurrencyLabel;
              }}
          ...
          !p.isMobile && (
            <div
              ref={repCurrencyContainer => {
                this.repCurrencyContainer = repCurrencyContainer;
              }}
            ...
            >
              <span
                ref={repCurrencyValue => {
                  this.repCurrencyValue = repCurrencyValue;
                }}
                className={Styles["AccountHeader__Currency-value"]}
              >
                {repValue}
                <span
                  ref={repCurrencyLabel => {
                    this.repCurrencyLabel = repCurrencyLabel;
                  }}
                  className={Styles["AccountHeader__Currency-label"]}
                >
