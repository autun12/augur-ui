...
export default class BaseInnerNav extends Component<BaseInnerNavProps, {}> {
  getMainMenuData() {
    return [];
  }
  getSubMenuData() {
  ...
  render() {
    const showMainMenu =
      this.props.mobileMenuState >= mobileMenuStates.FIRSTMENU_OPEN;
    const showSubMenu =
      this.props.mobileMenuState === mobileMenuStates.SUBMENU_OPEN;
