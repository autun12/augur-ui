...
export default class MarketsInnerNav extends BaseInnerNav {
  ...
  componentWillReceiveProps(nextProps) {
    if (
      ...
      !isEqual(
        this.props.marketsFilteredSorted,
        nextProps.marketsFilteredSorted
      ) ||
  ...
  updateFilteredTags(markets, marketsFilteredSorted, location) {
    ...
    const selectedTags = parseStringToArray(
      decodeURIComponent(parseQuery(location.search)[TAGS_PARAM_NAME] || ""),
    ...
    filteredTags = uniq(filteredTags).slice(0, 50);
