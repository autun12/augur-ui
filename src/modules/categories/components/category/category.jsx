...
import {
  CATEGORY_VOLUME_INCREASED,
  CATEGORY_VOLUME_DECREASED,
  NULL_CATEGORY
} from "modules/categories/constants/category-popularity-change";
...
export default class Category extends Component {
  ...
  componentWillUpdate(nextProps, nextState) {
    ...
    if (popularity !== nextProps.popularity)
      this.updatePopularity(
        nextProps.popularity > popularity
          ? CATEGORY_VOLUME_INCREASED
          : CATEGORY_VOLUME_DECREASED
      );
  }
          ...
          <div className={Styles.Category__popularity}>
            <span
              className={classNames({
                "bounce-up-and-flash":
                  s.popularityChange === CATEGORY_VOLUME_INCREASED,
                "bounce-down-and-flash":
                  s.popularityChange === CATEGORY_VOLUME_DECREASED
              })}
              data-tip
