...
const SideBarFilterIcon = () => (
  <svg className="side-bar-filter-icon" viewBox="0 0 400 400">
    <g>
      <polygon
        fill="#FFFFFF"
        points="323.1,81.4 370.2,28.8 29.8,28.8 77,81.4"
      />
      <polygon
        fill="#FFFFFF"
        points="114.3,122.9 161.5,175.5 238.8,175.5 285.9,122.9"
      />
