...
const BinaryIcon = () => (
  <svg viewBox="0 0 400 400">
    <g>
      ...
      <g>
        <path d="M144.6,272.44A72.44,72.44,0,1,1,217,200,72.52,72.52,0,0,1,144.6,272.44Z" />
        <path d="M144.6,128.06A71.94,71.94,0,1,1,72.66,200a72,72,0,0,1,71.94-71.94m0-1A72.94,72.94,0,1,0,217.54,200a72.94,72.94,0,0,0-72.94-72.94Z" />
      </g>
    </g>
  </svg>
);
