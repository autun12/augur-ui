...
export const MarketStatusOpen = (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
    <g fill="none" fillRule="evenodd">
      <g id="Markets/Card/Binary" stroke="#9B8BF5">
        <g id="Icon/Open">
          <circle id="Oval-5" cx="12" cy="12" r="4" />
          <circle id="Oval-5" cx="12" cy="12" r="11" />
        </g>
      </g>
    </g>
  </svg>
...
export const MarketStatusReported = (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
    <g id="Symbols" fill="none" fillRule="evenodd">
      <g id="Markets/Card/Multi" stroke="#412468">
        <g id="Icon/Reporting">
          <g id="Group" transform="translate(1 1)">
            <path
              ...
              d="M5 11.43l4.708 3.44L17 7"
            />
            <circle id="Oval-2" cx="11" cy="11" r="11" />
          </g>
        </g>
      </g>
    </g>
...
export const MarketStatusClosed = (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
    <g fill="none" fillRule="evenodd">
      <g id="Markets/Card/Multi-Long" stroke="#A7A2B2">
        <g id="Icon/Closed">
          <g id="Group" transform="translate(1 1)">
            <circle id="Oval-2" cx="11" cy="11" r="11" />
            <path d="M3 4l15.5 14.5" id="Line" strokeLinecap="square" />
          </g>
        </g>
      </g>
    </g>
...
export const IconSearch = (
  <svg viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
    <g id="Symbols" fill="none" fillRule="evenodd" fillOpacity=".5">
      <g id="Markets/Header" fill="#FFF">
        <g id="Group-5">
          <path
...
export const Airbitz = (
  ...
  >
    <defs>
      ...
      <mask
        id="8e5ba2bf-221c-40d9-b8e1-8d88080f9371"
        x="0"
        y="0"
        width="45.5"
        height="22.01"
      ...
      >
        <g transform="translate(-1 -12.69)">
          <g id="c70f333d-4852-43d5-b6b2-d7f3a0373259" data-name="mask-2">
            <polygon
              id="1efbfaab-efe7-466c-8f4b-d2828857cb32"
              data-name="path-1"
              className="5adafa42-3bbf-42b1-82df-2f38d7915eaf"
              points="46.5 12.69 46.5 34.7 1 34.7 1 12.69 46.5 12.69 1 12.69 1 34.7 46.5 34.7 46.5 12.69 46.5 12.69"
            />
          </g>
        </g>
      </mask>
      <mask
        id="d01e4ea2-d3bd-49bb-9d51-5c376617b0c4"
        x="0"
        y="0"
        width="45.5"
        height="10.28"
      ...
      >
        <g transform="translate(-1 -12.69)">
          <g id="a5e84cd7-4cde-46e1-853d-48dffba00e35" data-name="mask-4">
            <polygon
              id="5ce6f515-967d-42f9-9754-adcebce5d36d"
              data-name="path-3"
              className="5adafa42-3bbf-42b1-82df-2f38d7915eaf"
              points="46.5 12.69 46.5 22.97 1 22.97 1 12.69 46.5 12.69"
            />
          </g>
        </g>
      </mask>
        ...
        <g id="98e1bbc2-eee8-4a8e-8f94-2e8f97a9b718" data-name="Page-1">
          ...
          <g id="ffda8b8f-e469-4a2e-acae-896545f5e4bf" data-name="Group-6">
            <g className="1ae8a9e7-e9b6-43ec-9f04-98e99371b427">
              <path
                id="2939735f-6a50-444a-84ff-7df7fef1db0b"
                data-name="Fill-4"
                className="5adafa42-3bbf-42b1-82df-2f38d7915eaf"
                d="M23.37,12.69A32.11,32.11,0,0,1,46,21.74a4.7,4.7,0,0,1,.39.41.45.45,0,0,1,0,.66.49.49,0,0,1-.68,0,2.09,2.09,0,0,1-.21-.2,29.81,29.81,0,0,0-14.43-8A30.39,30.39,0,0,0,4.13,20.79c-.74.59-1.41,1.26-2.11,1.9-.33.3-.6.36-.84.14s-.23-.52.11-.85a31.71,31.71,0,0,1,7.48-5.52,31,31,0,0,1,11.48-3.54c1.16-.12,2.34-.17,3.13-.23"
                transform="translate(-1 -12.69)"
              />
            </g>
          </g>
          <path
            id="1aa7fcc8-1631-49ef-a64b-ebdcbd3ee740"
            data-name="Fill-7"
            className="5adafa42-3bbf-42b1-82df-2f38d7915eaf"
            d="M40.73,28.35c-.16.18-.26.4-.4.42a.83.83,0,0,1-.61-.14c-.63-.52-1.2-1.11-1.84-1.62a21.5,21.5,0,0,0-10.69-4.7,22.3,22.3,0,0,0-19.28,6.2,2,2,0,0,1-.23.22.49.49,0,0,1-.66,0,.46.46,0,0,1-.07-.64,2.21,2.21,0,0,1,.31-.34,23,23,0,0,1,13.55-6.5,23.25,23.25,0,0,1,19.44,6.52,5.23,5.23,0,0,1,.48.61"
            transform="translate(-1 -12.69)"
          />
          <path
            id="d0df3d2c-071d-430d-8cc6-3583fe00819c"
            data-name="Fill-9"
            className="5adafa42-3bbf-42b1-82df-2f38d7915eaf"
            d="M34.88,34.23c-.16.17-.27.38-.42.42a.76.76,0,0,1-.57-.13c-.49-.39-.93-.85-1.43-1.22a14.14,14.14,0,0,0-13.52-2.12,13.45,13.45,0,0,0-5.24,3.28c-.37.37-.86.32-.95-.11a.8.8,0,0,1,.23-.6,14.92,14.92,0,0,1,3.66-2.68A15.39,15.39,0,0,1,34.5,33.71a4,4,0,0,1,.38.52"
            transform="translate(-1 -12.69)"
          />
        </g>
      </g>
        ...
        {!!unseenCount && (
          <g id="Group-14" transform="translate(1.000000, 2.000000)">
            ...
            <text
              ...
              fill="#341D53"
            >
              <tspan x="4.01902362" y="10.0428031">
                {unseenCount}
              </tspan>
            </text>
          </g>
