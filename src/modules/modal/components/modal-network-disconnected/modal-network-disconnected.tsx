...
type ModalNetworkDisconnectedProps = {
  modal?: {
    env: object,
    connection: object
  },
  updateEnv: (...args: any[]) => any
};
type ModalNetworkDisconnectedState = {
  showEnvForm: boolean,
  showEnvForm: boolean,
  [x: number]: any,
  showEnvForm: boolean,
  ...
  render() {
    ...
    return (
      <section className={Styles.ModalNetworkDisconnected}>
        ...
        <span>
          You have been disconnected from your Augur Node. Please wait while we
          try to reconnect you, or update your node addresses{" "}
        ...
        {s.showEnvForm && (
          ...
          >
            <h1 className={Styles.ModalNetworkDisconnected__formTitle}>
            ...
            <label htmlFor="modal__dc-ethNodeHttp">
              ...
              <input
                ...
                onChange={e =>
                  this.updateField("ethereumNodeHttp", e.target.value)
                }
              />
            </label>
            <label htmlFor="modal__dc-ethereumNodeWs">
              ...
              <input
                ...
                onChange={e =>
                  this.updateField("ethereumNodeWs", e.target.value)
                }
              />
            </label>
