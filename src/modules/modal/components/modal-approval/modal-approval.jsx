...
import Styles from "modules/modal/components/modal-approval/modal-approval.styles.less";

const ModalApproval = p => (
  <section className={Styles.ModalApproval}>
    <h1>Approve Augur</h1>
    <p>
      In order to trade on Augur you must first approve the Augur Contracts to
      move your Ether on your behalf. You will not be able to to trade until
      approval has been completed.
    </p>
    <p>
      After clicking &quot;Approve&quot; you will be asked to sign a
      transaction, followed by a second transaction to complete your requested
      trade.
    </p>
