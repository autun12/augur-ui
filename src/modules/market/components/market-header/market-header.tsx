...
type MarketHeaderState = {
  areMarketDetailsVisible: boolean
};
    ...
    return (
      <section className={Styles.MarketHeader}>
        ...
        <div className={Styles[`MarketHeader__main-values`]}>
          <h1 className={Styles.MarketHeader__description}>{p.description}</h1>
          <div className={Styles.MarketHeader__properties}>
            {!!p.coreProperties &&
              Object.keys(p.coreProperties).map(property => (
                <div key={property} className={Styles.MarketHeader__property}>
                  <span>{property}</span>
        ...
        <div className={Styles[`MarketHeader__details-wrapper`]}>
          <button
            ...
            onClick={() =>
              toggleHeight(this.marketDetails, s.areMarketDetailsVisible, () =>
                this.setState({
                  areMarketDetailsVisible: !s.areMarketDetailsVisible
                })
              )
            }
          >
            additional details{" "}
            {s.areMarketDetailsVisible ? ChevronUp : ChevronDown}
          </button>
          <div
            ref={marketDetails => {
            ...
            className={classNames(
              Styles[`MarketHeader__details-container`],
          ...
          >
            ...
            <div className={Styles[`MarketHeader__resolution-source`]}>
