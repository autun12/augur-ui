...
type MarketPositionsListMobileProps = {
  outcome: object,
  positions: any[],
  openOrders: any[],
  scalarShareDenomination: object
};
type MarketPositionsListMobileState = {
  showViewMore: boolean,
  visibleOrders: any
};
export default class MarketPositionsListMobile extends Component<
  MarketPositionsListMobileProps,
  MarketPositionsListMobileState
> {
  constructor(props) {
    super(props);
    this.state = {
            ...
            {s.showViewMore && (
              <button
                ...
                onClick={e =>
                  this.setState({
                    showViewMore: false,
                    visibleOrders: p.openOrders.length
                  })
                }
              >
                +View More
