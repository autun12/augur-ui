    ...
    <section className={Styles.TradingConfirm}>
      ...
      <ul className={Styles.TradingConfirm__details}>
        ...
        {p.orderType === MARKET && (
          <li>
            ...
            <span>
              {p.marketOrderTotal instanceof BigNumber
                ? p.marketOrderTotal.toNumber()
                : p.marketOrderTotal}{" "}
              ETH
            </span>
          </li>
        ...
        {p.orderType === LIMIT && (
          <li>
            <span>Quantity</span>
            <span>
              {p.orderQuantity instanceof BigNumber
                ? p.orderQuantity.toNumber()
                : p.orderQuantity}{" "}
              Shares
            </span>
          </li>
        ...
        {p.orderType === LIMIT && (
          <li>
            ...
            <span>
              {p.orderPrice instanceof BigNumber
                ? p.orderPrice.toNumber()
                : p.orderPrice}{" "}
              ETH
            </span>
          </li>
        ...
        <li>
          <span>Fee</span>
          <span>
            {tradingFees} <span>ETH ({feePercent}%)</span>
          </span>
        </li>
      </ul>
      {p.orderType === LIMIT && (
        <ul className={Styles.TradingConfirm__total}>
          <li>
            <span>Total Cost</span>
            <span>
              <ValueDenomination formatted={totalCost.formatted} />{" "}
              <span>ETH</span>
            </span>
          </li>
        </ul>
      ...
      <ul className={Styles.TradingConfirm__potential}>
        <li>
          ...
          <span>
            <ValueDenomination formatted={potentialEthProfit.formatted} />{" "}
            <span>ETH ({potentialProfitPercent.formatted}%)</span>
          </span>
        </li>
        <li>
          ...
          <span>
            <span>
              <ValueDenomination formatted={potentialEthLoss.formatted} />{" "}
              <span>ETH ({potentialLossPercent.formatted}%)</span>
            </span>
          </span>
        </li>
      </ul>
