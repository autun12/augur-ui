...
import {
  BINARY_NO_ID,
  BINARY_NO_OUTCOME_NAME,
  BINARY_YES_ID,
  BINARY_YES_OUTCOME_NAME,
...
export function selectOutcomeName(
  outcomeID,
  marketType,
  marketOutcomesData = {}
) {
  ...
  if (marketType === BINARY) {
    ...
    outcomeName = marketOutcomesData[outcomeID]
      ? marketOutcomesData[outcomeID].name
      : outcomeID;
  }
  return outcomeName;
}
export function formatReportedOutcome(
  rawReportedOutcome,
  minPrice,
  maxPrice,
  marketType,
  ...
  const report = augur.reporting.format.unfixReport(
    rawReportedOutcome,
    minPrice,
    maxPrice,
    marketType
  );
  const outcomeName = report.isIndeterminate
    ? INDETERMINATE_OUTCOME_NAME
    : selectOutcomeName(report.report, marketType, marketOutcomesData || {});
  return outcomeName;
}
