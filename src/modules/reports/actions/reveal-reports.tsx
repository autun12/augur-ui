  ...
  return (dispatch, getState) => {
    ...
    if (branch.isReportRevealPhase && loginAccount.rep && reports) {
      ...
      const revealableReports = Object.keys(branchReports)
        .filter(
          eventID =>
            branchReports[eventID].reportHash &&
            branchReports[eventID].reportHash.length &&
            !branchReports[eventID].isRevealed &&
            branchReports[eventID].period === branch.reportPeriod
        )
        .map(eventID => {
