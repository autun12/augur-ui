  ...
  parallel(
    {
      designatedReporting: next =>
        augur.markets.getMarketsAwaitingDesignatedReporting(query, next),
      limitedReporting: next =>
        augur.markets.getMarketsAwaitingLimitedReporting(query, next),
      allReporting: next =>
        augur.markets.getMarketsAwaitingAllReporting(query, next)
    },
