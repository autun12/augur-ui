...
export default function() {
  ...
  const totalValue = formatEtherTokens(
    new BigNumber(
      (positionsSummary &&
        ...
        0,
      10
    ).plus(new BigNumber((marketsSummary && marketsSummary.totalNet) || 0, 10))
  );
  const netChange = formatEtherTokens(
    new BigNumber(
      (positionsSummary &&
      ...
      new BigNumber((marketsSummary && marketsSummary.totalValue) || 0, 10)
    )
  );
  return {
    totalValue,
