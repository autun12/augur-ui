...
type MyMarketsProps = {
  ...
  loadMarkets: (...args: any[]) => any,
  loadMarketsInfo: (...args: any[]) => any,
  isMobile?: boolean
};
type MyMarketsState = {
  filteredMarketsOpen: any[],
  openMarkets: any[],
  filteredMarketsReporting: any[],
  reportingMarkets: any[],
  filteredMarketsFinal: any[],
  finalMarkets: any[],
  sortTypeOpen: any,
  filterTypeOpen: any,
  sortTypeReporting: any,
  filterTypeReporting: any,
  sortTypeFinal: any,
  filterTypeFinal: any,
  sortOptionsOpen: { label: string, value: string }[],
  sortDefaultOpen: string,
  sortTypeOpen: string,
  filterOptionsOpen: { label: string, value: string }[],
  filterDefaultOpen: string,
  filterTypeOpen: string,
  sortOptionsReporting: { label: string, value: string }[],
  sortDefaultReporting: string,
  sortTypeReporting: string,
  filterOptionsReporting: { label: string, value: string }[],
  filterDefaultReporting: string,
  filterTypeReporting: string,
  sortOptionsFinal: { label: string, value: string }[],
  sortDefaultFinal: string,
  sortTypeFinal: string,
  filterOptionsFinal: { label: string, value: string }[],
  filterDefaultFinal: string,
  filterTypeFinal: string,
  openMarkets: any[],
  reportingMarkets: any[],
  finalMarkets: any[],
  filteredMarketsOpen: any[],
...
class MyMarkets extends Component<MyMarketsProps, MyMarketsState> {
  constructor(props) {
    super(props);
      ...
      <section className={Styles.Markets}>
        ...
        {p.myMarkets &&
          !!p.myMarkets.length && (
            <div className={Styles.Markets__SortBar}>
              <div className={Styles["Markets__SortBar-title"]}>Open</div>
              <div className={Styles["Markets__SortBar-sort"]}>
                <Dropdown
                  default={s.sortDefaultOpen}
                  options={s.sortOptionsOpen}
                  onChange={this.changeDropdown}
                />
              </div>
              <div className={Styles["Markets__SortBar-filter"]}>
                <Dropdown
                  default={s.filterDefaultOpen}
                  options={s.filterOptionsOpen}
                  onChange={this.changeDropdown}
                />
              </div>
            </div>
        ...
        {haveMarkets && (
          <div className={Styles.Markets__SortBar}>
            ...
            <div className={Styles["Markets__SortBar-sort"]}>
              <Dropdown
                default={s.sortDefaultReporting}
                options={s.sortOptionsReporting}
                onChange={this.changeDropdown}
              />
            </div>
            <div className={Styles["Markets__SortBar-filter"]}>
              <Dropdown
                default={s.filterDefaultReporting}
                options={s.filterOptionsReporting}
                onChange={this.changeDropdown}
              />
            </div>
          </div>
        ...
        {haveMarkets && (
          <div className={Styles.Markets__SortBar}>
            <div className={Styles["Markets__SortBar-title"]}>Finalized</div>
            <div className={Styles.Markets__SortBar}>
              <Dropdown
                default={s.sortDefaultFinal}
                options={s.sortOptionsFinal}
                onChange={this.changeDropdown}
              />
            </div>
            <div className={Styles["Markets__SortBar-filter"]}>
              <Dropdown
                default={s.filterDefaultFinal}
                options={s.filterOptionsFinal}
                onChange={this.changeDropdown}
              />
            </div>
          </div>
