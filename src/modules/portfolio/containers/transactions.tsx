...
const mapDispatchToProps = dispatch => ({
  loadAccountHistoryTransactions: (beginDate, endDate) =>
    dispatch(loadAccountHistory(beginDate, endDate))
});
const Transactions = withRouter(
  connect(mapStateToProps, mapDispatchToProps)(TransactionsList)
);
