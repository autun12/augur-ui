...
type CreateMarketReviewState = {
  ...
  gasCost: any,
  designatedReportNoShowReputationBond: any,
  creationFee: any,
  validityBond: any,
  creationFee: null,
  gasCost: null,
...
> {
  constructor(props) {
    ...
    this.state = {
      ...
      formattedInitialLiquidityFees: formatEtherTokensEstimate(
        this.props.newMarket.initialLiquidityFees
      )
    };
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (
      this.props.newMarket.initialLiquidityFees !==
      nextProps.newMarket.initialLiquidityFees
    )
      this.setState({
        formattedInitialLiquidityFees: formatEtherTokensEstimate(
          nextProps.newMarket.initialLiquidityFees
  ...
  calculateMarketCreationCosts() {
    augur.createMarket.getMarketCreationCostBreakdown(
      { universe: this.props.universe.id, meta: this.props.meta },
