...
type MarketPreviewCategoricalProps = {
  newMarket: object
};
type MarketPreviewCategoricalState = {
...
class MarketPreviewCategorical extends Component<
  MarketPreviewCategoricalProps,
  MarketPreviewCategoricalState
> {
  constructor(props) {
    super(props);
    this.state = {
      ...
      >
        ...
        <div
          className={classNames(
            Styles["MarketPreviewCategorical__outcomes-container"],
            {
        ...
        >
          ...
          >
            {cleanedOutcomes.length > 0 &&
              cleanedOutcomes.map((outcome, i) => (
                <CategoricalOutcome key={i} outcome={outcome} />
              ))}
          </div>
        </div>
      </div>
