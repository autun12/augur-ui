...
type MarketsViewProps = {
  ...
  markets: any[],
  filteredMarkets: any[],
  canLoadMarkets: boolean,
  hasLoadedMarkets: boolean,
  hasLoadedCategory: object,
  loadMarkets: (...args: any[]) => any,
  loadMarketsByCategory: (...args: any[]) => any,
  location: object,
  history: object,
  updateMarketsFilteredSorted: (...args: any[]) => any,
  clearMarketsFilteredSorted: (...args: any[]) => any,
  toggleFavorite: (...args: any[]) => any,
  loadMarketsInfo: (...args: any[]) => any,
  isMobile?: boolean
};
export default class MarketsView extends Component<MarketsViewProps, {}> {
  componentWillMount() {
    loadMarkets({
  ...
  componentWillReceiveProps(nextProps) {
    if (
      (this.props.canLoadMarkets !== nextProps.canLoadMarkets &&
        nextProps.canLoadMarkets) ||
      this.props.location !== nextProps.location ||
      this.props.hasLoadedCategory !== nextProps.hasLoadedCategory ||
      (this.props.hasLoadedMarkets !== nextProps.hasLoadedMarkets &&
        !nextProps.hasLoadedMarkets)
    ) {
      loadMarkets({
