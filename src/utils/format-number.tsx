...
export function formatEtherTokens(num, opts) {
  return formatNumber(encodeNumberAsJSNumber(num), {
...
export function formatShares(num, opts) {
  const formattedShares = formatNumber(encodeNumberAsJSNumber(num), {
    decimals: 2,
    decimalsRounded: 2,
...
function addBigUnitPostfix(value, formattedValue) {
  ...
  if (value.gt(new BigNumber("1000000000000", 10))) {
    ...
    postfixed =
      value.dividedBy(new BigNumber("1000000000", 10)).toFixed(0) + "B";
