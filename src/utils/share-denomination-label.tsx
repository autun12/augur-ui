...
export default function(selectedDenomination, shareDenominations) {
  switch (selectedDenomination) {
    case MICRO_SHARE: {
      const value =
        shareDenominations &&
        shareDenominations.find(
          denomination => denomination.value === MICRO_SHARE
        );
    ...
    case MILLI_SHARE: {
      const value =
        shareDenominations &&
        shareDenominations.find(
          denomination => denomination.value === MILLI_SHARE
        );
    ...
    case SHARE: {
      const value =
        shareDenominations &&
        shareDenominations.find(denomination => denomination.value === SHARE);
