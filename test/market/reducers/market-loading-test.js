...
describe("modules/market/reducers/market-loading", () => {
  ...
  it("should return the default state, existing state undefined", () => {
  ...
  it("should return the default state when action type is RESET_STATE", () => {
  ...
  it("should return the existing state, existing state defined", () => {
    const actual = marketLoading(
      { "0xMarket1": "loading" },
      {
        type: null
  ...
  it("should return the expected object for case UPDATE_MARKET_LOADING", () => {
    const actual = marketLoading(
      {},
      {
  ...
  it("should return the expected object for case REMOVE_MARKET_LOADING", () => {
    const actual = marketLoading(
      {
        "0xMARKETID1": "state1",
        "0xMARKETID2": "state2"
