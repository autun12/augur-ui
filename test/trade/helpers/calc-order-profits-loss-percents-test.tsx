...
describe("modules/trade/helpers/calc-order-profit-loss-percents.js", () => {
  ...
  test({
    ...
    assertions: () => {
      const actual = calcProfits("10", "0.4", BUY, "1", "2", BINARY);
      const expected = {
  ...
  test({
    ...
    assertions: () => {
      const actual = calcProfits("10", "0.4", SELL, "1", "2", BINARY);
      const expected = {
  ...
  test({
    ...
    assertions: () => {
      const actual = calcProfits("10", "1", BUY, "-5", "10", SCALAR);
      const expected = {
  ...
  test({
    ...
    assertions: () => {
      const actual = calcProfits("10", "1", SELL, "-5", "10", SCALAR);
      const expected = {
