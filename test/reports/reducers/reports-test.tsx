...
describe(`modules/reports/reducers/reports.js`, () => {
  ...
  describe("CLEAR_OLD_REPORTS", () => {
        ...
        t.assertions(
          reducer(t.state.reports, {
            ...
            currentReportingWindowAddress:
              t.state.universe.currentReportingWindowAddress
          })
        )
      );
    test({
    ...
    test({
      description:
        "one old and one current report, old report committed and revealed",
      state: {
        universe: {
          id: "0xb1",
          currentReportingWindowAddress: 7
    ...
    test({
      description:
        "two current reports and two old reports on universe 1, one current report and three old reports on universe 2",
      state: {
        universe: {
          id: "0xb1",
          currentReportingWindowAddress: 7
