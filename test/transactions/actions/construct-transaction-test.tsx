...
describe("modules/transactions/actions/construct-transaction.js", () => {
  ...
  describe("loadDataForMarketTransaction", () => {
    const action = proxyquire(
      "../../../src/modules/transactions/actions/construct-transaction",
      {
    ...
    test({
      ...
      assertions: store => {
        ...
        const callback = () => {};
        store.dispatch(
          action.loadDataForMarketTransaction(label, log, isRetry, callback)
        );
        ...
        assert.deepEqual(
          actual,
          expected,
          `Didn't return the expected actions`
        );
      }
    });
    test({
      ...
      assertions: store => {
        ...
        assert.isTrue(
          callback.calledOnce,
          `Didn't call callback once as expected`
        );
      }
    });
    test({
  ...
  describe("loadDataForReportingTransaction", () => {
    ...
    test({
      ...
      assertions: store => {
        ...
        const callback = () => {};
        store.dispatch(
          action.loadDataForReportingTransaction(label, log, isRetry, callback)
        );
        const actual = store.getActions();
        const expected = [
          {
  ...
  describe("constructBasicTransaction", () => {
    ...
    test({
      description:
        "should return the expected object with just hash and status passed",
      assertions: store => {
        const hash = "0xHASH";
        const status = "status";
    ...
    test({
      description:
        "should return the expected object with all arguments passed",
      assertions: store => {
        const hash = "0xHASH";
        const status = "status";
  ...
  describe("constructCollectedFeesTransaction", () => {
    ...
    test({
      ...
      assertions: () => {
        ...
        const initialRepBalance = new BigNumber(log.newRepBalance)
          .minus(repGain)
          .toFixed();
        const expected = {
          data: {},
    ...
    test({
      ...
      assertions: () => {
        ...
        const percentRep = formatPercent(
          new BigNumber(log.initialRepBalance)
      ...
      assertions: () => {
        ...
        const expected = {
          data: {
            balances: [
              {
                change: formatRep(new BigNumber(log._value, 10), {
                  positiveSign: true
                })
              }
            ]
  ...
  describe("constructCreateMarketTransaction", () => {
    ...
    test({
      ...
      assertions: () => {
        ...
        const actual = action.constructCreateMarketTransaction(
          log,
          description
        );
        const expected = {
  ...
  describe("constructTradingProceedsClaimedTransaction", () => {
    ...
    test({
      ...
      assertions: () => {
        ...
        const actual = action.constructTradingProceedsClaimedTransaction(
          log,
          market
        );
        const expected = {
      ...
      assertions: () => {
        ...
        const expected = {
          data: {
            ...
            balances: [
              {
                change: formatEtherTokens(log.payoutTokens, {
                  positiveSign: true
                }),
  ...
  describe("constructSubmitReportTransaction", () => {
    ...
    test({
      ...
      assertions: () => {
        ...
        const result = action.constructSubmitReportTransaction(
          log,
          marketID,
          market
        );
  ...
  describe("constructFillOrderTransaction", () => {
    ...
    test({
      ...
      assertions: store => {
        ...
        assert.deepEqual(
          store.dispatch(
            action.constructFillOrderTransaction(
              order,
              marketID,
              marketType,
              description,
    ...
    describe("related conditionals: order type", () => {
      ...
      test({
        ...
        assertions: store => {
          ...
          assert.deepEqual(
            store.dispatch(
              action.constructCreateOrderTransaction(
                order,
                marketID,
                marketType,
                description,
  ...
  describe("constructCancelOrderTransaction", () => {
    ...
    test({
      ...
      assertions: store => {
        const actual = store.dispatch(
          action.constructCancelOrderTransaction(
            trade,
            marketID,
            marketType,
            description,
        ...
        const expected = {
          "0xHASH": {
            ...
            message: `canceled order to ${trade.orderType} ${shares.full} for ${
              price.full
            } each`,
            numShares: shares,
            noFeePrice: price,
      ...
      assertions: store => {
        ...
        const expected = {
          "0xHASH": {
            ...
            message: `canceling order to ${trade.orderType} ${
              shares.full
            } for ${price.full} each`,
            numShares: shares,
            noFeePrice: price,
  ...
  describe("constructTradingTransaction", () => {
    ...
    test({
      ...
      assertions: store => {
        store.dispatch(
          constructTransaction.constructTradingTransaction(
            "FillOrder",
            {},
            "0xMARKETID"
          )
