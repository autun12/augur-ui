...
describe("modal-claim-reporting-fees-forked-market", () => {
  ...
  describe("When displaying modal for claimable reporting fees", () => {
    ...
    describe("When there are claimable ETH fees, but no claimable REP fees", () => {
      ...
      beforeEach(() => {
        ...
        Cmp = shallow(
          <ModalClaimReportingFeesForkedMarket
            ...
            closeModal={sinon.spy()}
            recipient="0X913DA4198E6BE1D5F5E4A40D0667F70C0B5430EB"
            unclaimedEth={formatEther("0.123", {
              decimals: 4,
              zeroStyled: true
            })}
            unclaimedRep={formatAttoRep("0", { decimals: 4, zeroStyled: true })}
      ...
      describe("ETH field", () => {
        test("should match expected claimable ETH value", () => {
          expect(Cmp.html()).toContain("<span>Eth</span><span>0.1230</span>");
        });
      });
    ...
    describe("When there are claimable REP fees, but no claimable ETH fees", () => {
      ...
      beforeEach(() => {
        ...
        Cmp = shallow(
          <ModalClaimReportingFeesForkedMarket
            ...
            recipient="0X913DA4198E6BE1D5F5E4A40D0667F70C0B5430EB"
            unclaimedEth={formatEther("0", { decimals: 4, zeroStyled: true })}
            unclaimedRep={formatAttoRep("2000000000000000000", {
              decimals: 4,
              zeroStyled: true
            })}
            forkedMarket={forkedMarket}
      ...
      describe("REP field", () => {
        test("should match expected claimable REP value", () => {
          expect(Cmp.html()).toContain("<span>Rep</span><span>2.0000</span>");
        });
      });
