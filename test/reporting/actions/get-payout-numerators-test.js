...
describe(`modules/reporting/actions/get-payout-numerators.js`, () => {
  ...
  describe("scalar 75 sub 0 Min", () => {
    test({
      description: `should call the expected method`,
      assertions: () => {
        const actual = getPayoutNumerators(marketScalarMin, "75", false).map(
          n => n.toString()
        );
  ...
  describe("scalar 25 sub 0 Min", () => {
    test({
      description: `should call the expected method`,
      assertions: () => {
        const actual = getPayoutNumerators(marketScalarMin, "25", false).map(
          n => n.toString()
        );
  ...
  describe("scalar 45.01", () => {
    test({
      description: `should call the expected method`,
      assertions: () => {
        const actual = getPayoutNumerators(marketScalar, "45.01", false).map(
          n => n.toString()
        );
