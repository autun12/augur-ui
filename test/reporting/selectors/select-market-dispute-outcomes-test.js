...
describe(`modules/reports/selectors/select-market-dispute-outcomes.js`, () => {
  ...
  describe("default method", () => {
    it("should call `selectMarketDisputeOutcomes` from the default function", done => {
  ...
  describe("selectMarketDisputeOutcomes", () => {
    it(`selectMarketDisputeOutcomes, should return an empty object`, done => {
    ...
    describe("only disputing markets", () => {
      it(`When no dispute info, should return a mapping of market id to a list of outcomes`, done => {
        const marketData = [
