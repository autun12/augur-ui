...
describe("modules/create-market/reducers/liquidity-orders.js", () => {
  ...
  test({
    describe:
      "should handle adding market liquidity orders if no market existed before",
    assertions: () => {
      const data = {
        marketId: "marketId",
        liquidityOrders: {
  ...
  test({
    describe:
      "should handle removing a specific order when a market still has more orders for that outcome",
    assertions: () => {
      const data = {
        marketId: "marketId",
        outcomeId: 1,
  ...
  test({
    describe:
      "should handle removing the last order for a specific outcome on a market with more outcome orders to place",
    assertions: () => {
      const data = {
        marketId: "marketId",
        outcomeId: "apple",
