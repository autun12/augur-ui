...
describe("modules/create-market/actions/submit-new-market", () => {
  ...
  test({
    ...
    assertions: store => {
      ...
      sinon
        .stub(mockAugur.createMarket, "createCategoricalMarket")
        .callsFake(createMarketObject => {
  ...
  test({
    ...
    assertions: store => {
      ...
      let formattedNewMarket = null;
      sinon
        .stub(mockAugur.createMarket, "createBinaryMarket")
        .callsFake(createMarketObject => {
          delete createMarketObject.onSent;
          delete createMarketObject.onSuccess;
          delete createMarketObject.onFailed;
  ...
  test({
    ...
    assertions: store => {
      ...
      let formattedNewMarket = null;
      sinon
        .stub(mockAugur.createMarket, "createScalarMarket")
        .callsFake(createMarketObject => {
          delete createMarketObject.onSent;
          delete createMarketObject.onSuccess;
          delete createMarketObject.onFailed;
  ...
  test({
    ...
    assertions: store => {
      ...
      __RewireAPI__.__Rewire__(
        ...
        (callReturn, outcomeID, type, quantity, price, nogo, cb) => {
          cb({});
          return {
      ...
      __RewireAPI__.__Rewire__(
        "placeTrade",
        (callReturn, outcomeID, tradeToExecute, nogo, cb) => {
          cb();
          return {
            type: "placeTrade",
            outcomeID
