...
export default function(scalarShareDenomination) {
  assert.isDefined(
    ...
    `scalarShareDenomination isn't defined`
  );
  assert.isObject(
    scalarShareDenomination,
    `scalarShareDenomination isn't an object`
  );
  ...
  describe("scalarShareDenomination.denominations", () => {
    ...
    (denominations || []).forEach(denomination => {
      assert.isDefined(
        denomination,
        `denominations.denomination isn't defined`
      );
      assert.isObject(
        denomination,
        `denominations.denomination isn't an object`
      );
  ...
  assert.isDefined(
    scalarShareDenomination.updateSelectedShareDenomination,
    `updateSelectedShareDenomination isn't defined`
  );
  assert.isFunction(
    scalarShareDenomination.updateSelectedShareDenomination,
    `updateSelectedShareDenomination isn't a function`
  );
}
