...
describe(`modules/auth/actions/load-account-data.js`, () => {
  ...
  test({
    description:
      "account with address, loginID, name, isUnlocked, airbitzAccount",
    params: {
      account: {
        address: "0xb0b",
        name: "jack",
