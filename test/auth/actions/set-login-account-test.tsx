  ...
  const test = t => {
    it(t.description, () => {
      ...
      const action = proxyquire(
        "../../../src/modules/auth/actions/set-login-account.js",
        {
      ...
      sinon
        .stub(UseUnlockedAccount, "useUnlockedAccount")
        .callsFake(account => ({ type: "USE_UNLOCKED_ACCOUNT", account }));
      store.dispatch(
        action.setLoginAccount(t.params.autoLogin, t.params.account)
      );
