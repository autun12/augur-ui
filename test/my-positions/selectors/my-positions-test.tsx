...
import myPositions, {
  __RewireAPI__
} from "modules/my-positions/selectors/my-positions";
  ...
  describe("selectPositionsMarkets", () => {
    test({
      ...
      assertions: () => {
        ...
        const userMarkets = {
          selectAllUserOpenOrderMarkets: () => ["0xMARKETID2"]
        };
        const selector = proxyquire(
          "../../../src/modules/my-positions/selectors/my-positions.js",
          {
