...
describe(`modules/my-positions/selectors/my-positions-summary.js`, () => {
  describe("generateOutcomePositionSummary", () => {
    ...
    test(
      `should return the expected value when adjusted positions are undefined`,
      () => {
    ...
    test(
      `should return the expected value when adjusted positions are defined AND position is zero`,
      () => {
    ...
    test(
      `should return the expected value when adjusted positions are defined AND position is non-zero`,
      () => {
        const actual = generateOutcomePositionSummary([
          {
            averagePrice: 0.2,
  ...
  describe("generateMarketsPositionsSummary", () => {
    ...
    test(
      `should return the expected object if there ARE markets with positions AND no outcomes have position object`,
      store => {
        const actual = generateMarketsPositionsSummary([
          {
            id: "0xMARKETID1",
    ...
    test(
      `should return the expected object if there ARE markets with positions AND outcomes have position`,
      store => {
        const actual = generateMarketsPositionsSummary([
          {
            id: "0xMARKETID1",
